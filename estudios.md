...
<style>
    ...
    .cert-title { font-size: 1.1rem; font-weight: 700; color: #2c3e50; margin: 0 !important; }
    ...
    .cert-card ul { font-size: 0.85rem; color: #57606f; margin-top: 10px; column-count: 2; list-style-type: '✔️ '; padding-left: 20px; }
</style>
