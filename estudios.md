...
La certificación valida el conocimiento y las habilidades avanzadas en el soporte y la gestión de SUSE Rancher, una plataforma de administración de Kubernetes que simplifica la implementación, gestión y escalado de clústeres de Kubernetes.
...
La certificación valida la competencia avanzada en la implementación, soporte y administración de SUSE Linux Enterprise Server (SLES), un sistema operativo empresarial robusto y versátil utilizado para servidores y entornos críticos de misión.<br/>
